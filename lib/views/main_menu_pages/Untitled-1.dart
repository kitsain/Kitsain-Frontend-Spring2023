        ...
        content: Container(
          ...
          child: Padding(
            ...
            child: DropdownButtonFormField<String>(
              menuMaxHeight: 200,
              value: _shoppingList,
              icon: Positioned(right: 30, child: Icon(Icons.arrow_drop_down)),
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                  ...
                  icon:
                      Icon(Icons.arrow_drop_up, color: Colors.black, size: 35))
            ],
          ),
        ),
                                        ...
                                        child: Card(
                                          ...
                                          child: ClipPath(
                                            child: Container(
                                                ...
                                                child: ListTile(
                                                  title: Text(
                                                      '${_selectedTabs[0] ? StateController.usedList[index - 1] : StateController.expiredList[index - 1]}',
                                                      style: TextStyle(
                                                          fontWeight:
                                                              FontWeight.bold,
                                                          fontSize: 23)),
